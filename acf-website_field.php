...
if (is_admin()) { // note the use of is_admin() to double check that this is happening in the admin
    $config = array(
        ...
        'raw_url' => 'https://raw.github.com/Jeradin/acf-website-field/Development', // the github raw url of your github repo
        'github_url' => 'https://github.com/Jeradin/acf-website-field', // the github url of your github repo
        'zip_url' => 'https://github.com/Jeradin/acf-website-field/zipball/Development', // the zip url of the github repo
